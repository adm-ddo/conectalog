...
import { entrarPortal } from "./actions";

export default function LoginPortalForm() {
  const [state, formAction, pending] = useActionState(entrarPortal, undefined);
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-xl font-semibold text-navy-900">Portal do cliente</h1>
        <p className="text-sm text-stone-500 mt-1">Veja a escala de motoboys de hoje.</p>
      </div>

      <div className="flex flex-col gap-1">
        <label className="text-xs text-stone-500">Login</label>
        <input
          name="loginPortal"
          required
          autoFocus
